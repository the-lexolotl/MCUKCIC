...
export const metadata: Metadata = {
  ...
  description: 'Founder & Managing Director of Medicinal Cannabis UK CIC.',
}
  ...
  return (
    <div className="lp-shell">
      ...
      <div className="lp-profile">
        <div className="lp-profile-avatar">JH</div>
        <h1 className="lp-profile-name">Jane Hinchliffe</h1>
        <div className="lp-profile-role">Founder &amp; Managing Director · MCUK CIC</div>
        <p className="lp-profile-bio">
          Placeholder bio — Jane is the founder and Managing Director of Medicinal Cannabis UK CIC, established to provide patient-led support and advocacy for UK prescription cannabis patients.
        </p>
